...
1.6 You need to read the phone numbers of all the people whose last names start with the letter A. (Trick question! It involves concepts that are discussed in more detail in Chapter 4. Read the answer - it will probably surprise you!)
Answer: O(n)
